    ...
    '<p style="display:block;margin:0 4px 0 0;font-size: 8px;font-weight:bold;">Services Offered:</p>'+
		...
		'<button id="get_direction" style="  background: linear-gradient(to top, #f0a303 0%,#f7cb62 100%); border: 1px solid #f0a303;border-top-color: #f7cb62;'+
		'border-radius: 4px;height: 50px;padding: 0 10px;color: #111;font-weight: bold;cursor: pointer;outline: 0; margin-left: 4px;margin-top:4px; width: 42%;float: left;">Get Direction</button>'+
		'<button id="get_direction_current_location" style="background: linear-gradient(to top, #f0a303 0%,#f7cb62 100%); border: 1px solid #f0a303;border-top-color: #f7cb62;'+
		'border-radius: 4px;height: 50px;padding: 0 10px;color: #111;font-weight: bold;cursor: pointer;outline: 0;margin-top:4px;float: left;margin-left:4px;width: 50%;">Get Direction From Current Location</button>'+
		'</div>'+
		'</div>';
	}
			...
			/* setTimeout(function() { */
				...
				// }
					...
					if(jQuery.inArray("seating", element.branch_service) !== -1){
						$('<img src="https://media.megasportsworld.com/branch-locator/wp-content/themes/branch-locator/images/mapicon-st.png"  height="20" width="20" style="padding: 5px 5px 0px 4px;">').appendTo("#services");
					}		
					...
					if(jQuery.inArray("telebet_deposit", element.branch_service) !== -1){
						$('<img src="https://media.megasportsworld.com/branch-locator/wp-content/themes/branch-locator/images/mapicon-tldp.png"  height="20" width="20" style="padding: 5px 5px 0px 4px;">').appendTo("#services");
					}		
					if(jQuery.inArray("telebet_withdraw", element.branch_service) !== -1){
						$('<img src="https://media.megasportsworld.com/branch-locator/wp-content/themes/branch-locator/images/mapicon-tlwd.png"  height="20" width="20" style="padding: 5px 5px 0px 4px;">').appendTo("#services");
					}		
