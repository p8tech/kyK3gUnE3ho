	...
	function windowContent(title,address,telephone,email,address,lon,lat,branch_service,branch_thumbnail){
		...
		'border-radius: 4px;height: 35px;padding: 0 10px;color: #111;font-weight: bold;cursor: pointer;outline: 0;">Get Direction</button>&nbsp;&nbsp;&nbsp;'+
		...
		'border-radius: 4px;height: 35px;padding: 0 10px;color: #111;font-weight: bold;cursor: pointer;outline: 0;">Get Direction From Current Location</button>&nbsp;&nbsp;&nbsp;';
	}
